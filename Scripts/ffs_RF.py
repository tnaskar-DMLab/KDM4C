...
# Scale features (Random Forest is scale-invariant, but keeping for consistency)
...
models = {
    "RandomForest": RandomForestClassifier(
        ...
        max_depth=None,           # let it grow fully unless overfitting
...
# ----------------------------
# Run Random Forest forward selection
# ----------------------------
